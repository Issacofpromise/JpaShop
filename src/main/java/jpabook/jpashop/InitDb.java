...
/*em.persist(book2);*/OrderItem orderItem1 = OrderItem.createOrderItem(book1, 10000,
1);OrderItem orderItem2 = OrderItem.createOrderItem(book2, 20000, 2);
...
stockQuantity);em.persist(book1);return book1;}private Delivery createDelivery(Member member){
