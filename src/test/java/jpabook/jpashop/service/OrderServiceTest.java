...
/*@Test public void 상품주문_재고수량초과(){Member member=createMember();
Book book = createBook("JPA",20000,10);int orderCount = 11;
...
em.persist(book);  return book;} private Member createMember(){
